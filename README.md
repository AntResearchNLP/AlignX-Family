...
+ <strong>Just For the Sake of Research</strong>: all persona signals are fully synthesized using large language models, ensuring that no real private information is collected or exposed.
